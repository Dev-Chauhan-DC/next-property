...
const UpcomingProjects: React.FC<Props> = ({ builder }) => {
    ...
    const listSearchHandle = async () => {
        try {
            const result = await searchAndFilters(indiaViewport, { project_type_id: '3', view: 'list', page: 1, limit: 1, builder_id: builder?.id.toString() });
