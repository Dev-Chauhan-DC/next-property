    ...
    return (
        <View className='px-5 mt-3.5 mb-6'>
            <View className='flex flex-row items-center gap-1.5'>
                <Text className='text-xl text-black-800 font-mSemiBold'>Ravi Kewalramani </Text>
                <VerifiedIcon
                    width={14}
                    height={14}
                    fill={Colors.primary}
            ...
            <View className='flex flex-row gap-1.5 items-center mb-4'>
                <Text className='font-mRegular text-base text-gray-400'>10+ years of experience</Text>
